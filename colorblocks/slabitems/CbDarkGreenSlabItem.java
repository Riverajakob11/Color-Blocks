...
public class CbDarkGreenSlabItem extends ItemBlock
{
    private final boolean field_150948_b;
    private final BlockSlab field_150949_c;
    private final BlockSlab field_150947_d;
    
	public CbDarkGreenSlabItem(Block block) {
		super(block);

		this.field_150948_b = false;
		this.field_150949_c = ColorBlocks.CbDarkGreenHalfSlab;
		this.field_150947_d = ColorBlocks.CbDarkGreenFullSlab;
	   }
