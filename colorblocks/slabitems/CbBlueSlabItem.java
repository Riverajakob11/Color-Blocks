...
public class CbBlueSlabItem extends ItemBlock
{
    private final boolean field_150948_b;
    private final BlockSlab field_150949_c;
    private final BlockSlab field_150947_d;
    
	public CbBlueSlabItem(Block block) {
		super(block);

		this.field_150948_b = false;
		this.field_150949_c = ColorBlocks.CbBlueHalfSlab;
		this.field_150947_d = ColorBlocks.CbBlueFullSlab;
	   }
