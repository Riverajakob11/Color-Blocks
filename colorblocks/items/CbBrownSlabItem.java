...
public class CbBrownSlabItem extends ItemBlock
{
    private final boolean field_150948_b;
    private final BlockSlab field_150949_c;
    private final BlockSlab field_150947_d;
    
	public CbBrownSlabItem(Block block) {
		super(block);

		this.field_150948_b = false;
		this.field_150949_c = ColorBlocks.CbBrownHalfSlab;
		this.field_150947_d = ColorBlocks.CbBrownFullSlab;
	   }
